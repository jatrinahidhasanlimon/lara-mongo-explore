...
class WaterTrasportReportController extends Controller
{
    ...
    {
        $all_companies = WaterCompany::select('id','name')->get();
        // return $all_companies;
        // return WaterTicket::find('61d2b98d3082e040a8af3945');
        ...
        // $tickets  = WaterTicket::where('createdAt', new \DateTime('2022-1-3'))->get();
        // //$tickets  = WaterTicket::select('createdAt')->take(5)->latest()->get();
        // return $tickets;
        
        $tickets  = WaterTicket::select('companyId','companyName','totalSeat','totalAmount','ticketType','ticketDateTime','tripDateTime')->take(500)->get()->groupBy('companyId');
